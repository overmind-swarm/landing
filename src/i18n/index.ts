...
export const translations = {
  en: {
    ...
    'privacy.aiTransparencyTitle': '9. AI Transparency (Art. 50 EU AI Act)',
    'privacy.aiTransparencyText': 'In compliance with Article 50 of the EU AI Act (Regulation 2024/1689), we inform you that CuriaBots is an AI-powered service. All bot interactions — including responses, suggestions, reminders, and automated actions — are generated by artificial intelligence models. No human operator participates in or monitors individual conversations. AI-generated content may contain errors or inaccuracies. You should verify important information independently.',
    ...
    'terms.lastUpdated': 'Last updated: April 25, 2026',
    ...
    'terms.serviceText': 'CuriaBots is a platform for managing autonomous AI bots. Each bot operates in an isolated environment and can perform tasks such as agenda management, reminders, and workflow automation on your behalf. In accordance with Article 50 of the EU AI Act (Regulation 2024/1689), we inform you that all interactions with CuriaBots bots are powered by artificial intelligence. The responses, suggestions, and actions performed by your bots are generated by AI models, not by humans.',
  ...
  es: {
    ...
    'privacy.aiTransparencyTitle': '9. Transparencia de IA (Art. 50 Reglamento de IA de la UE)',
    'privacy.aiTransparencyText': 'De conformidad con el Artículo 50 del Reglamento de IA de la UE (Reglamento 2024/1689), le informamos de que CuriaBots es un servicio impulsado por inteligencia artificial. Todas las interacciones con los bots — incluyendo respuestas, sugerencias, recordatorios y acciones automatizadas — son generadas por modelos de inteligencia artificial. Ningún operador humano participa en ni monitoriza las conversaciones individuales. El contenido generado por IA puede contener errores o inexactitudes. Debe verificar la información importante de forma independiente.',
    ...
    'terms.lastUpdated': 'Última actualización: 25 de abril de 2026',
    ...
    'terms.serviceText': 'CuriaBots es una plataforma de gestión de bots de IA autónomos. Cada bot opera en un entorno aislado y puede realizar tareas como gestión de agenda, recordatorios y automatización de flujos de trabajo en su nombre. De conformidad con el Artículo 50 del Reglamento de IA de la UE (Reglamento 2024/1689), le informamos de que todas las interacciones con los bots de CuriaBots están impulsadas por inteligencia artificial. Las respuestas, sugerencias y acciones realizadas por sus bots son generadas por modelos de IA, no por personas.',
